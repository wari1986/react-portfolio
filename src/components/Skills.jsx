...
const Skills = () => {
  return (
    <div name='skills' className='w-full h-screen bg-primary-default text-primary-text'>
      {/* Container */}
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          <div>
              <p className='text-4xl font-bold inline border-b-4 border-primary-contrast '>Skills</p>
